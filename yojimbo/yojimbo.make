...
DEFINES += -DYOJIMBO_DEBUG -DNETCODE_DEBUG -DRELIABLE_DEBUG -DNETCODE_ENABLE_TESTS=1 -DRELIABLE_ENABLE_TESTS=1
...
DEFINES += -DYOJIMBO_RELEASE -DNETCODE_RELEASE -DRELIABLE_RELEASE -DNETCODE_ENABLE_TESTS=1 -DRELIABLE_ENABLE_TESTS=1
...
GENERATED += $(OBJDIR)/netcode.o
GENERATED += $(OBJDIR)/reliable.o
GENERATED += $(OBJDIR)/tlsf.o
GENERATED += $(OBJDIR)/yojimbo.o
OBJECTS += $(OBJDIR)/certs.o
OBJECTS += $(OBJDIR)/netcode.o
OBJECTS += $(OBJDIR)/reliable.o
OBJECTS += $(OBJDIR)/tlsf.o
OBJECTS += $(OBJDIR)/yojimbo.o
